...
val appModule = module {
    ...
    viewModel { (groupName: String) -> MovieChannelsViewModel( groupName, presenter = get(), favoriteInteractor = get() ) }
    ...
    viewModel { (groupName: String) -> TvChannelsViewModel( groupName, presenter = get(), favoriteInteractor = get() ) }
}